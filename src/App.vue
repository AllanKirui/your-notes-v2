...
.default-theme .outer-ring {
  background: url("@/assets/img/outer-spinner-ring-default.svg") no-repeat
    center center;
}

.default-theme .inner-ring {
  background: url("@/assets/img/inner-spinner-ring-default.svg") no-repeat
    center center;
}

.purplish-theme .outer-ring {
  background: url("@/assets/img/outer-spinner-ring-purplish.svg") no-repeat
    center center;
}

.purplish-theme .inner-ring {
  background: url("@/assets/img/inner-spinner-ring-purplish.svg") no-repeat
    center center;
}

.bluetiful-theme .outer-ring {
  background: url("@/assets/img/outer-spinner-ring-bluetiful.svg") no-repeat
    center center;
}

.bluetiful-theme .inner-ring {
  background: url("@/assets/img/inner-spinner-ring-bluetiful.svg") no-repeat
    center center;
}
...
@media (max-width: 768px) {
  ...
  .content-wrapper .btn-wrapper .add-new-btn {
    width: 2.5rem;
    height: 2.5rem;
    border-radius: 50px;
    transition: all 0.15s ease-in-out;
  ...
  .default-theme .content-wrapper .btn-wrapper .add-new-btn {
    background-color: var(--color-dark-pastel-green);
    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;
  }

  .purplish-theme .content-wrapper .btn-wrapper .add-new-btn {
    background-color: var(--color-tickle-me-pink);
    box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;
  }

  .purplish-theme .content-wrapper .btn-wrapper .add-new-btn:hover {
    background-color: var(--color-spanish-pink);
  }

  .bluetiful-theme .content-wrapper .btn-wrapper .add-new-btn {
    background-color: var(--color-maximum-blue-green);
    box-shadow: rgba(0, 0, 0, 0.35) 0px 3px 8px;
  }

  .bluetiful-theme .content-wrapper .btn-wrapper .add-new-btn:hover {
